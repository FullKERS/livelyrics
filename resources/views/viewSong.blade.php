...
<body>
    ...
    <div class="scroll-button">
        <button class="btn btn-primary" onclick="scrollToTop()"><</button>
        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#songModal">...</button>
        <button class="btn btn-primary" onclick="scrollToBottom()">></button>
    </div>
